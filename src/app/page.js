...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      // Si hay error (ej. contraseña incorrecta), puedes mostrar un alert o mensaje en pantalla
      alert("Error al iniciar sesión: " + error.message);
      setLoading(false);
      return;
    }

    // Si fue exitoso, redirigimos al dashboard (o la ruta que prefieras como principal)
